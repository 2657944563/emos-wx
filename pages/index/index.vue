<template>
	<view class="page">
		...
		<view class="notify-container">
			...
			<view class="notify-content">你有{{ unreadRow }}条未读消息</view>
		...
		<view class="nav-container">
			<view class="nav-row">
				...
				<view class="nav">
					<image @tap="toPage('每周签到', '../checkin_result/checkin_result')" src="../../static/nav-2.png" mode="widthFix" class="icon"></image>
